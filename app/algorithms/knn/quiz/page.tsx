...
export default function QuizPage() {
  ...
  useEffect(() => {
    // Since we only have 10 questions, we'll use all of them
      ...
      <header className={cn(
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-6">
            <Link href="/algorithms/knn" className="text-gray-300 hover:text-white transition-colors flex items-center gap-1">
              <ArrowLeft className="w-4 h-4" />
              Back to KNN Visualizer
            </Link>
          </nav>
        </div>
      </header>
          ...
          {!showResult ? (
            <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-8">
              <div className="mb-6">
                <div className="flex justify-between items-center mb-4">
                  <h1 className="text-2xl font-bold">K-Nearest Neighbors Quiz</h1>
            ...
            <div className="backdrop-blur-lg bg-white/5 border border-white/10 rounded-xl p-8">
              <div className="text-center mb-8">
                ...
                {score === questions.length ? (
                  ...
                  <div className="p-4 bg-blue-500/20 border border-blue-500/30 rounded-lg text-blue-300 mb-8">
                    <p className="font-medium">Great job! You have a solid understanding of K-Nearest Neighbors.</p>
                  </div>
                  ...
                  <div className="p-4 bg-red-500/20 border border-red-500/30 rounded-lg text-red-300 mb-8">
                    <p className="font-medium">Keep practicing! KNN concepts can be tricky.</p>
                  </div>
                )}
              </div>
              ...
              <div className="flex gap-4">
                ...
                <Link href="/algorithms/knn" className="flex-1">
                  <Button 
