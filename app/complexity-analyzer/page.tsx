...
const analyzeCode = async () => {
  ...
  try {
    ...
    if (analysisResult.detectedAlgorithm) {
      setDetectedAlgorithm(analysisResult.detectedAlgorithm);
    }
  } catch (err) {
    ...
    <div className="min-h-screen text-white">
      <header className={cn(
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <div>
            <h1 className="text-lg sm:text-xl font-bold">Code Complexity Analyzer</h1>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Analyze your code to determine its time and space complexity. 
              Understand the efficiency of your algorithms and identify potential bottlenecks.
            </p>
          </div>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        <p className="max-w-xs">
                          Paste your code here for analysis. The analyzer works best with algorithm implementations and functions.
                        </p>
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
          ...
          <div className="glass-card p-6 rounded-xl">
            <h2 className="text-2xl font-bold mb-4">About Complexity Analysis</h2>
            <div className="space-y-4 text-gray-300">
              <p>
                Time and space complexity are measures used to analyze the efficiency of algorithms:
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                <div className="p-4 bg-gray-800/50 rounded-lg">
                  <h3 className="text-xl font-semibold mb-2">Common Time Complexities</h3>
                  <ul className="list-disc list-inside space-y-2">
                    <li><strong>O(1)</strong> - Constant time: operations that don't depend on input size</li>
                    <li><strong>O(log n)</strong> - Logarithmic time: divide and conquer algorithms</li>
                    <li><strong>O(n)</strong> - Linear time: operations that process each input element once</li>
                    <li><strong>O(n log n)</strong> - Linearithmic time: efficient sorting algorithms</li>
                    <li><strong>O(n²)</strong> - Quadratic time: nested iterations over the input</li>
                    <li><strong>O(2ⁿ)</strong> - Exponential time: recursive algorithms without memoization</li>
                  </ul>
                </div>
                
                <div className="p-4 bg-gray-800/50 rounded-lg">
                  <h3 className="text-xl font-semibold mb-2">Common Space Complexities</h3>
                  <ul className="list-disc list-inside space-y-2">
                    <li><strong>O(1)</strong> - Constant space: fixed amount of memory regardless of input</li>
